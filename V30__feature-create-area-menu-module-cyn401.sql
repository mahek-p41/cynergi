...
(5,2,'APCHKLST','APCHKRPT','List A/P Checks','list.a/p.checks'),
...
(12,2,'APPURGE','APPURGE','Purge A/P Records','purge.a/p.records'),
(13,2,'APRPT','APRPT','A/P Report','a/p.report'),
...
(17,2,'APUTIL','APUTIL','A/P Utilities','a/p.utilities'),
...
(22,4,'POADD','PO','Add P/O','add.p/o'),
(23,4,'POCHG','PO','Change P/O','change.p/o'),
(24,4,'PODEL','PO','Delete P/O','delete.p/o'),
(25,4,'POINLOAD','POINLOAD','Receive From PO','receive.from.po'),
(26,4,'POLST','POLISTS','List P/O','list.p/o'),
(27,4,'POPARAMS','PARAMS','Control File Main','control.file.main'),
(28,4,'POPURGE','POPURGE','Purge P/O Records','purge.p/o.records'),
...
(32,4,'PORPT','PORPT','P/O Report','p/o.report'),
(33,4,'POSHO','POX','Show P/O','show.p/o'),
(34,4,'POUPDT','POUPDT','Update P/O','update.p/o'),
(35,4,'POUTIL','POUTIL','P/O Utilities','p/o.utilities'),
...
(42,4,'POCAN','PO','Cancel P/O','cancel.p/o'),
