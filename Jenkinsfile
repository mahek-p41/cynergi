      ...
      stage('Deploy DEVELOP Artifacts') {
         ...
         steps {
            script {
               ...
               sh "sshpass -p '$CYNERGI_DEPLOY_JENKINS_PSW' ssh -oStrictHostKeyChecking=no $CYNERGI_DEPLOY_JENKINS_USR@172.19.10.17 bash -c \"'ln -s /home/jenkins/ELIMINATION/DEVELOP/cynergi-middleware-${gradleProps.releaseVersion}.tar.xz /home/jenkins/ELIMINATION/DEVELOP/cynergi-middleware-current.tar.xz '\""
      ...
      stage('Deploy STAGING Artifacts') {
         ...
         steps {
            script {
               ...
               sh "sshpass -p '$CYNERGI_DEPLOY_JENKINS_PSW' ssh -oStrictHostKeyChecking=no $CYNERGI_DEPLOY_JENKINS_USR@172.19.10.17 bash -c \"'ln -s /home/jenkins/ELIMINATION/STAGING/cynergi-middleware-${gradleProps.releaseVersion}.tar.xz /home/jenkins/ELIMINATION/STAGING/cynergi-middleware-current.tar.xz '\""
      ...
      stage('Deploy RELEASE Artifacts') {
         ...
         steps {
            script {
               ...
               sh "sshpass -p '$CYNERGI_DEPLOY_JENKINS_PSW' ssh -oStrictHostKeyChecking=no $CYNERGI_DEPLOY_JENKINS_USR@172.19.10.17 bash -c \"'ln -s /home/jenkins/ELIMINATION/RELEASE/cynergi-middleware-${gradleProps.releaseVersion}.tar.xz /home/jenkins/ELIMINATION/RELEASE/cynergi-middleware-current.tar.xz '\""
