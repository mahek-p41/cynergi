      ...
      stage('Deploy DEVELOP Artifacts') {
         ...
         steps {
            script {
               ...
               sh "sshpass -p '$CYNERGI_DEPLOY_JENKINS_PSW' ssh -oStrictHostKeyChecking=no $CST_DEPLOY_LOGIN_USR@172.29.3.143 bash -c \"'touch /home/jenkins/ELIMINATION/DEVELOP/build.trigger '\""
            }
         }
      }
      ...
      stage('Deploy STAGING Artifacts') {
         ...
         steps {
            script {
               ...
               sh "sshpass -p '$CYNERGI_DEPLOY_JENKINS_PSW' ssh -oStrictHostKeyChecking=no $CST_DEPLOY_LOGIN_USR@172.29.3.143 bash -c \"'touch /home/jenkins/ELIMINATION/STAGING/build.trigger '\""
            }
         }
      }
      ...
      stage('Deploy RELEASE Artifacts') {
         ...
         steps {
            script {
               ...
               sh "sshpass -p '$CYNERGI_DEPLOY_JENKINS_PSW' ssh -oStrictHostKeyChecking=no $CST_DEPLOY_LOGIN_USR@172.29.3.143 bash -c \"'touch /home/jenkins/ELIMINATION/RELEASE/build.trigger '\""
            }
         }
      }
   }
