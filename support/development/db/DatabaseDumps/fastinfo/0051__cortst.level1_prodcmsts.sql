...
CREATE INDEX index_level1_prodcmsts_on_ht_etl_processing_stage ON cortst.level1_prodcmsts USING btree (ht_etl_processing_stage) WHERE (ht_etl_processing_stage < 10);
