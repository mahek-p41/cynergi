...
script
 ...
 exec /opt/cyn/v01/cynmid/java/openj9/${VER_BUILD}/bin/java \$JAVA_MEM_OPTS \$JAVA_GC_OPTS \$JAVA_SYS_PROPS -jar /opt/cyn/v01/cynmid/cynergi-middleware.jar
end script
