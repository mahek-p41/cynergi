...
VALUES (1, 'ACCOUNTS_PAYABLE', 'Account Payable', 'account.payable', (SELECT id FROM area_type_domain WHERE value = 'AP'), 0),
       ...
       (28, 'HOME_OFFICE', 'HOME OFFICE', 'home.office', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 1),
       (29, 'BANK', 'Bank Maintenance', 'bank.maintenance', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 2),
       (30, 'CHART_OF_ACCOUNT', 'Chart of Account', 'chart.of.account', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 3),
       (31, 'DISTRIBUTION_TEMPLATE_MAINTENANCE', 'Distribution Template Maintenance', 'distribution.template.maintenance', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 4),
       (32, 'FINANCIAL_STATEMENT', 'Financial Statement', 'financial.statement', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 5),
       (33, 'GL_SOURCE_CODE', 'GL SOURCE CODE', 'gl.source.code', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 6),
       (34, 'SHIPVIA', 'Ship Via Maintenance', 'ship.via.maintenance', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 7),
       (35, 'VENDOR', 'Vendor Maintenance', 'vendor.maintenance', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 8),
       (36, 'VENDOR_GROUP', 'Vendor Group', 'vendor.group', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 9),
       (37, 'RESTRICTED_MASTER_CONTROL_FILES', 'RESTRICTED MASTER CONTROL FILES', 'restricted.master.control.files', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 10),
       (38, 'COMPANY', 'Company Maintenance', 'company.maintenance', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 11),
       (39, 'VENDOR_TERM_CODE', 'Vendor Term Code', 'vendor.term.code', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 12),
       (40, 'AP_CONTROL', 'AP Control', 'account.payable.control', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 13),
       (41, 'PO_CONTROL', 'PO Control', 'po.control', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 14),
       (42, 'GL_CONTROL', 'GL Control', 'general.ledger.control', (SELECT id FROM area_type_domain WHERE value = 'MCF'), 15)
;
