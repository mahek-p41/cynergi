...
(
    ...
    purchase_order_id          UUID REFERENCES purchase_order_header (id),
    ...
    message                    TEXT,
    selected_id                INTEGER REFERENCES account_payable_invoice_selected_type_domain (id) NOT NULL,
    multiple_payment_indicator BOOLEAN     DEFAULT FALSE                                           NOT NULL,
    paid_amount                NUMERIC(12, 2)                                                      NOT NULL,
    selected_amount            NUMERIC(12, 2),
    type_id                    INTEGER REFERENCES account_payable_invoice_type_domain (id)          NOT NULL,
    status_id                  INTEGER REFERENCES account_payable_invoice_status_type_domain (id)   NOT NULL,
    due_date                   DATE                                                                NOT NULL,
    pay_to_id                  UUID REFERENCES vendor (id)                                         NOT NULL,
...
(
    ...
    distribution_account_id           UUID REFERENCES account (id)                 NOT NULL,
