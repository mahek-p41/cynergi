...
(
    ...
    status_id                            INTEGER REFERENCES account_payable_recurring_invoice_status_type_domain (id) NOT NULL,
    ...
    expense_month_creation_indicator_id  INTEGER REFERENCES expense_month_creation_type_domain (id)                   NOT NULL,
...
(
    ...
    time_created                      TIMESTAMPTZ DEFAULT CLOCK_TIMESTAMP()                  NOT NULL,
    time_updated                      TIMESTAMPTZ DEFAULT CLOCK_TIMESTAMP()                  NOT NULL,
    recurring_invoice_id              UUID REFERENCES account_payable_recurring_invoice (id) NOT NULL,
