...
VALUES (1, 1, 'AP MENU', 'Account Payable Menu', 'account.payable.menu'),
...
VALUES (1, 2, 'APADD', 'AP', 'Add Invoices', 'add.invoices'),
...
CREATE TABLE menu_to_module_type_domain
(
...
COMMENT ON TABLE menu_to_module_type_domain IS 'Join table which joins the menus to the modules';

INSERT INTO menu_to_module_type_domain (menu_type_id, module_type_id)
VALUES (5, 1),
       (5, 4),
       (5, 8),
       (5, 10),
