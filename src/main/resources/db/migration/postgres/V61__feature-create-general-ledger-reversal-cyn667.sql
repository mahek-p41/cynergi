...
(
    ...
    general_ledger_detail_id      BIGINT REFERENCES general_ledger_detail (id)                                NOT NULL,
    comment                       TEXT,
...
CREATE INDEX general_ledger_reversal_source_id_idx ON general_ledger_recurring(source_id);
