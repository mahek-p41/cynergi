...
(
    ...
    type_id                        INTEGER REFERENCES account_type_domain (id)                NOT NULL,
    normal_account_balance_type_id INTEGER REFERENCES normal_account_balance_type_domain (id) NOT NULL,
    status_type_id                 INTEGER REFERENCES account_status_type_domain (id)         NOT NULL,
