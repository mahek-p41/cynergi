CREATE TABLE account_payable_default_status_type_domain
(
...
INSERT INTO account_payable_default_status_type_domain(id, value, description, localization_code)
...
(
    ...
    drop_five_chars_model_number           BOOLEAN     DEFAULT FALSE                                         NOT NULL,
    update_account_payable                 BOOLEAN     DEFAULT FALSE                                         NOT NULL,
    print_second_desc                      BOOLEAN     DEFAULT FALSE                                         NOT NULL,
    account_payable_default_status_type_id BIGINT REFERENCES account_payable_default_status_type_domain (id) NOT NULL,
