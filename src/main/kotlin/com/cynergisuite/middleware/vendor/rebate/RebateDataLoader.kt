...
object RebateDataLoader {
   ...
   @JvmStatic
   fun stream(numberIn: Int = 1, vendor: Identifiable, generalLedgerDebitAccount: AccountEntity? = null, generalLedgerCreditAccount: AccountEntity? = null): Stream<RebateEntity> {
   ...
   @JvmStatic
   fun streamDTO(numberIn: Int = 1, vendorIn: SimpleIdentifiableDTO, generalLedgerDebitAccountIn: SimpleIdentifiableDTO? = null, generalLedgerCreditAccountIn: SimpleIdentifiableDTO? = null): Stream<RebateDTO> {
      val number = if (numberIn < 0) 1 else numberIn
      val faker = Faker()
      val random = faker.random()
      val lorem = faker.lorem()
...
class RebateDataLoaderService @Inject constructor(
   ...
   fun stream(numberIn: Int = 1, companyIn: Company, vendorIn: Identifiable, generalLedgerDebitAccountIn: AccountEntity? = null, generalLedgerCreditAccountIn: AccountEntity? = null): Stream<RebateEntity> {
   ...
   fun single(companyIn: Company, vendorIn: Identifiable, generalLedgerDebitAccountIn: AccountEntity? = null, generalLedgerCreditAccountIn: AccountEntity? = null): RebateEntity {
   ...
   fun singleDTO(vendorIn: SimpleIdentifiableDTO, generalLedgerDebitAccountIn: SimpleIdentifiableDTO? = null, generalLedgerCreditAccountIn: SimpleIdentifiableDTO? = null): RebateDTO {
