...
class FreightOnboardTypeRepository @Inject constructor(
   ...
   fun findOne(id: Long): FreightOnboardTypeEntity? {
   ...
   fun findOne(value: String): FreightOnboardTypeEntity? {
   ...
   fun findAll(): List<FreightOnboardTypeEntity> =
...
) : RowMapper<FreightOnboardTypeEntity> {
   override fun mapRow(rs: ResultSet, rowNum: Int): FreightOnboardTypeEntity =
      mapRow(rs, columnPrefix)

   fun mapRow(rs: ResultSet, columnPrefix: String): FreightOnboardTypeEntity =
