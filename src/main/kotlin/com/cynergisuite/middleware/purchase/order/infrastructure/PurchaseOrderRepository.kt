   ...
   private fun selectBaseQuery(): String {
      return """
         ...
         SELECT
            ...
            count(*) OVER()                                     AS total_elements,
            shipTo.v_id                                         AS po_shipTo_id,
            shipTo.v_uu_row_id                                  AS po_shipTo_uu_row_id,
            shipTo.v_time_created                               AS po_shipTo_time_created,
            shipTo.v_time_updated                               AS po_shipTo_time_updated,
            shipTo.v_company_id                                 AS po_shipTo_company_id,
            shipTo.v_number                                     AS po_shipTo_number,
            shipTo.v_name                                       AS po_shipTo_name,
            shipTo.v_address_id                                 AS po_shipTo_address_id,
            shipTo.v_account_number                             AS po_shipTo_account_number,
            shipTo.v_pay_to_id                                  AS po_shipTo_pay_to_id,
            shipTo.v_freight_on_board_type_id                   AS po_shipTo_freight_on_board_type_id,
            shipTo.v_payment_terms_id                           AS po_shipTo_payment_terms_id,
            shipTo.v_normal_days                                AS po_shipTo_normal_days,
            shipTo.v_return_policy                              AS po_shipTo_return_policy,
            shipTo.v_ship_via_id                                AS po_shipTo_ship_via_id,
            shipTo.v_group_id                                   AS po_shipTo_group_id,
            shipTo.v_minimum_quantity                           AS po_shipTo_minimum_quantity,
            shipTo.v_minimum_amount                             AS po_shipTo_minimum_amount,
            shipTo.v_free_ship_quantity                         AS po_shipTo_free_ship_quantity,
            shipTo.v_free_ship_amount                           AS po_shipTo_free_ship_amount,
            shipTo.v_vendor_1099                                AS po_shipTo_vendor_1099,
            shipTo.v_federal_id_number                          AS po_shipTo_federal_id_number,
            shipTo.v_sales_representative_name                  AS po_shipTo_sales_representative_name,
            shipTo.v_sales_representative_fax                   AS po_shipTo_sales_representative_fax,
            shipTo.v_separate_check                             AS po_shipTo_separate_check,
            shipTo.v_bump_percent                               AS po_shipTo_bump_percent,
            shipTo.v_freight_calc_method_type_id                AS po_shipTo_freight_calc_method_type_id,
            shipTo.v_freight_percent                            AS po_shipTo_freight_percent,
            shipTo.v_freight_amount                             AS po_shipTo_freight_amount,
            shipTo.v_charge_inventory_tax_1                     AS po_shipTo_charge_inventory_tax_1,
            shipTo.v_charge_inventory_tax_2                     AS po_shipTo_charge_inventory_tax_2,
            shipTo.v_charge_inventory_tax_3                     AS po_shipTo_charge_inventory_tax_3,
            shipTo.v_charge_inventory_tax_4                     AS po_shipTo_charge_inventory_tax_4,
            shipTo.v_federal_id_number_verification             AS po_shipTo_federal_id_number_verification,
            shipTo.v_email_address                              AS po_shipTo_email_address,
            shipTo.v_purchase_order_submit_email_address        AS po_shipTo_purchase_order_submit_email_address,
            shipTo.v_allow_drop_ship_to_customer                AS po_shipTo_allow_drop_ship_to_customer,
            shipTo.v_auto_submit_purchase_order                 AS po_shipTo_auto_submit_purchase_order,
            shipTo.v_note                                       AS po_shipTo_note,
            shipTo.v_phone_number                               AS po_shipTo_phone_number,
            shipTo.v_comp_id                                    AS po_shipTo_comp_id,
            shipTo.v_comp_uu_row_id                             AS po_shipTo_comp_uu_row_id,
            shipTo.v_comp_time_created                          AS po_shipTo_comp_time_created,
            shipTo.v_comp_time_updated                          AS po_shipTo_comp_time_updated,
            shipTo.v_comp_name                                  AS po_shipTo_comp_name,
            shipTo.v_comp_doing_business_as                     AS po_shipTo_comp_doing_business_as,
            shipTo.v_comp_client_code                           AS po_shipTo_comp_client_code,
            shipTo.v_comp_client_id                             AS po_shipTo_comp_client_id,
            shipTo.v_comp_dataset_code                          AS po_shipTo_comp_dataset_code,
            shipTo.v_comp_federal_id_number                     AS po_shipTo_comp_federal_id_number,
            shipTo.v_comp_address_id                            AS po_shipTo_comp_address_id,
            shipTo.v_comp_address_name                          AS po_shipTo_comp_address_name,
            shipTo.v_comp_address_address1                      AS po_shipTo_comp_address_address1,
            shipTo.v_comp_address_address2                      AS po_shipTo_comp_address_address2,
            shipTo.v_comp_address_city                          AS po_shipTo_comp_address_city,
            shipTo.v_comp_address_state                         AS po_shipTo_comp_address_state,
            shipTo.v_comp_address_postal_code                   AS po_shipTo_comp_address_postal_code,
            shipTo.v_comp_address_latitude                      AS po_shipTo_comp_address_latitude,
            shipTo.v_comp_address_longitude                     AS po_shipTo_comp_address_longitude,
            shipTo.v_comp_address_country                       AS po_shipTo_comp_address_country,
            shipTo.v_comp_address_county                        AS po_shipTo_comp_address_county,
            shipTo.v_comp_address_phone                         AS po_shipTo_comp_address_phone,
            shipTo.v_comp_address_fax                           AS po_shipTo_comp_address_fax,
            shipTo.v_onboard_id                                 AS po_shipTo_onboard_id,
            shipTo.v_onboard_value                              AS po_shipTo_onboard_value,
            shipTo.v_onboard_description                        AS po_shipTo_onboard_description,
            shipTo.v_onboard_localization_code                  AS po_shipTo_onboard_localization_code,
            shipTo.v_method_id                                  AS po_shipTo_method_id,
            shipTo.v_method_value                               AS po_shipTo_method_value,
            shipTo.v_method_description                         AS po_shipTo_method_description,
            shipTo.v_method_localization_code                   AS po_shipTo_method_localization_code,
            shipTo.v_address_id                                 AS po_shipTo_address_id,
            shipTo.v_address_uu_row_id                          AS po_shipTo_address_uu_row_id,
            shipTo.v_address_time_created                       AS po_shipTo_address_time_created,
            shipTo.v_address_time_updated                       AS po_shipTo_address_time_updated,
            shipTo.v_address_number                             AS po_shipTo_address_number,
            shipTo.v_address_name                               AS po_shipTo_address_name,
            shipTo.v_address_address1                           AS po_shipTo_address_address1,
            shipTo.v_address_address2                           AS po_shipTo_address_address2,
            shipTo.v_address_city                               AS po_shipTo_address_city,
            shipTo.v_address_state                              AS po_shipTo_address_state,
            shipTo.v_address_postal_code                        AS po_shipTo_address_postal_code,
            shipTo.v_address_latitude                           AS po_shipTo_address_latitude,
            shipTo.v_address_longitude                          AS po_shipTo_address_longitude,
            shipTo.v_address_country                            AS po_shipTo_address_country,
            shipTo.v_address_county                             AS po_shipTo_address_county,
            shipTo.v_address_phone                              AS po_shipTo_address_phone,
            shipTo.v_address_fax                                AS po_shipTo_address_fax,
            shipTo.v_vpt_id                                     AS po_shipTo_vpt_id,
            shipTo.v_vpt_uu_row_id                              AS po_shipTo_vpt_uu_row_id,
            shipTo.v_vpt_time_created                           AS po_shipTo_vpt_time_created,
            shipTo.v_vpt_time_updated                           AS po_shipTo_vpt_time_updated,
            shipTo.v_vpt_company_id                             AS po_shipTo_vpt_company_id,
            shipTo.v_vpt_description                            AS po_shipTo_vpt_description,
            shipTo.v_vpt_number                                 AS po_shipTo_vpt_number,
            shipTo.v_vpt_number_of_payments                     AS po_shipTo_vpt_number_of_payments,
            shipTo.v_vpt_discount_month                         AS po_shipTo_vpt_discount_month,
            shipTo.v_vpt_discount_days                          AS po_shipTo_vpt_discount_days,
            shipTo.v_vpt_discount_percent                       AS po_shipTo_vpt_discount_percent,
            shipTo.v_shipVia_id                                 AS po_shipTo_shipVia_id,
            shipTo.v_shipVia_uu_row_id                          AS po_shipTo_shipVia_uu_row_id,
            shipTo.v_shipVia_time_created                       AS po_shipTo_shipVia_time_created,
            shipTo.v_shipVia_time_updated                       AS po_shipTo_shipVia_time_updated,
            shipTo.v_shipVia_description                        AS po_shipTo_shipVia_description,
            shipTo.v_shipVia_number                             AS po_shipTo_shipVia_number,
            shipTo.v_vgrp_id                                    AS po_shipTo_vgrp_id,
            shipTo.v_vgrp_uu_row_id                             AS po_shipTo_vgrp_uu_row_id,
            shipTo.v_vgrp_time_created                          AS po_shipTo_vgrp_time_created,
            shipTo.v_vgrp_time_updated                          AS po_shipTo_vgrp_time_updated,
            shipTo.v_vgrp_company_id                            AS po_shipTo_vgrp_company_id,
            shipTo.v_vgrp_value                                 AS po_shipTo_vgrp_value,
            shipTo.v_vgrp_description                           AS po_shipTo_vgrp_description,
            count(*) OVER()                                     AS total_elements,
