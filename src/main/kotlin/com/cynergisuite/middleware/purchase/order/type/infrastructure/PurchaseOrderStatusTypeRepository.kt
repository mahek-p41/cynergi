...
class PurchaseOrderStatusTypeRepository @Inject constructor(
   ...
   @ReadOnly fun exists(value: String): Boolean {
      val exists = jdbc.queryForObject(
         "SELECT EXISTS(SELECT id FROM purchase_order_status_type_domain WHERE UPPER(value) = :value)",
         mapOf(
   ...
   @ReadOnly fun findOne(id: Long): PurchaseOrderStatusType? {
   ...
   @ReadOnly fun findOne(value: String): PurchaseOrderStatusType? {
