...
class PurchaseOrderRequisitionIndicatorTypeRepository @Inject constructor(
   ...
   fun exists(value: String): Boolean {
      val exists = jdbc.queryForObject("SELECT EXISTS(SELECT id FROM purchase_order_requisition_indicator_type_domain WHERE UPPER(value) = :value)", mapOf("value" to value.toUpperCase()), Boolean::class.java)!!
   ...
   fun findOne(id: Long): PurchaseOrderRequisitionIndicatorType? {
   ...
   fun findOne(value: String): PurchaseOrderRequisitionIndicatorType? {
