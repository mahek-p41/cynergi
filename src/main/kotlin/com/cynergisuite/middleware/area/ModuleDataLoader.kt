...
object ModuleDataLoader {
   private val moduleTypes = listOf(
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(2)
      ),
      ModuleType(
         id = 2,
         value = "APSHO",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(4)
      ),
      ModuleType(
         id = 6,
         value = "APCHKRPT",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(21)
      ),
      ModuleType(
         id = 38,
         value = "PORECLST",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(14)
      ),
      ModuleType(
         id = 51,
         value = "ADDCOMP",
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(37)
      ),
      ModuleType(
         id = 52,
         value = "CHGCOMP",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(42)
      ),
      ModuleType(
         id = 59,
         value = "APLST",
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(35)
      ),
      ModuleType(
         id = 60,
         value = "ADDVEND",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(39)
      ),
      ModuleType(
         id = 74,
         value = "APPURGE",
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(41)
      ),
      ModuleType(
         id = 75,
         value = "APPARAMS",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(30)
      ),
      ModuleType(
         id = 77,
         value = "CHGACCT",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(43)
      ),
      ModuleType(
         id = 90,
         value = "ADDLAY",
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(32)
      ),
      ModuleType(
         id = 91,
         value = "CHGLAY",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(33)
      ),
      ModuleType(
         id = 98,
         value = "CHGGLCOD",
      ...
      ModuleType(
         ...
         menuType = MenuTypeDataLoader.menuTypes().forId(31)
      ),
      ModuleType(
         id = 104,
         value = "CHGAPDST",
