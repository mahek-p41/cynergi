...
data class GeneralLedgerJournalEntryDTO(
   ...
   @field:NotNull
   @field:Schema(name = "entryDate", description = "Entry date (GL period must be open)")
   ...
   @field:NotNull
   @field:Schema(name = "reverse", description = "Determines if GL Reversal records will be created")
   var reverse: Boolean? = null,

   @field:NotNull
   @field:Schema(name = "useTemplate", description = "Determines if an AP Distribution template will be used")
   ...
   @field:NotNull
   @field:Schema(name = "balance", description = "Journal entry balance (must be zero)")
   var balance: BigDecimal? = null,

   @field:Schema(name = "message", description = "Message", required = false)
   var message: String? = null,

   @field:Schema(name = "postReversingEntry", description = "Determines if the GL Reversal Entry will be posted (only available if the GL is open for the reversal date)", required = false)
