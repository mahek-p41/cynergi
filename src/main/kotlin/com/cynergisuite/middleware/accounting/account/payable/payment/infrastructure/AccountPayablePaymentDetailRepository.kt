...
class AccountPayablePaymentDetailRepository @Inject constructor(
   ...
   fun baseSelectQuery(): String {
      return """
         ...
         SELECT
            ...
            inv.apInvoice_vendor_active                              AS apPaymentDetail_apInvoice_vendor_active,
            ...
            inv.apInvoice_vendor_comp_include_demo_inventory         AS apPaymentDetail_apInvoice_vendor_comp_include_demo_inventory,
            ...
            inv.apInvoice_vendor_has_rebate                          AS apPaymentDetail_apInvoice_vendor_has_rebate,
            inv.apInvoice_payTo_id                                  AS apPaymentDetail_apInvoice_payTo_id,
            inv.apInvoice_payTo_company_id                          AS apPaymentDetail_apInvoice_payTo_company_id,
            inv.apInvoice_payTo_number                              AS apPaymentDetail_apInvoice_payTo_number,
            inv.apInvoice_payTo_name                                AS apPaymentDetail_apInvoice_payTo_name,
            inv.apInvoice_payTo_account_number                      AS apPaymentDetail_apInvoice_payTo_account_number,
            inv.apInvoice_payTo_pay_to_id                           AS apPaymentDetail_apInvoice_payTo_pay_to_id,
            inv.apInvoice_payTo_freight_on_board_type_id            AS apPaymentDetail_apInvoice_payTo_freight_on_board_type_id,
            inv.apInvoice_payTo_vendor_payment_term_id              AS apPaymentDetail_apInvoice_payTo_vendor_payment_term_id,
            inv.apInvoice_payTo_normal_days                         AS apPaymentDetail_apInvoice_payTo_normal_days,
            inv.apInvoice_payTo_return_policy                       AS apPaymentDetail_apInvoice_payTo_return_policy,
            inv.apInvoice_payTo_ship_via_id                         AS apPaymentDetail_apInvoice_payTo_ship_via_id,
            inv.apInvoice_payTo_group_id                            AS apPaymentDetail_apInvoice_payTo_group_id,
            inv.apInvoice_payTo_minimum_quantity                    AS apPaymentDetail_apInvoice_payTo_minimum_quantity,
            inv.apInvoice_payTo_minimum_amount                      AS apPaymentDetail_apInvoice_payTo_minimum_amount,
            inv.apInvoice_payTo_free_ship_quantity                  AS apPaymentDetail_apInvoice_payTo_free_ship_quantity,
            inv.apInvoice_payTo_free_ship_amount                    AS apPaymentDetail_apInvoice_payTo_free_ship_amount,
            inv.apInvoice_payTo_vendor_1099                         AS apPaymentDetail_apInvoice_payTo_vendor_1099,
            inv.apInvoice_payTo_federal_id_number                   AS apPaymentDetail_apInvoice_payTo_federal_id_number,
            inv.apInvoice_payTo_sales_representative_name           AS apPaymentDetail_apInvoice_payTo_sales_representative_name,
            inv.apInvoice_payTo_sales_representative_fax            AS apPaymentDetail_apInvoice_payTo_sales_representative_fax,
            inv.apInvoice_payTo_separate_check                      AS apPaymentDetail_apInvoice_payTo_separate_check,
            inv.apInvoice_payTo_bump_percent                        AS apPaymentDetail_apInvoice_payTo_bump_percent,
            inv.apInvoice_payTo_freight_calc_method_type_id         AS apPaymentDetail_apInvoice_payTo_freight_calc_method_type_id,
            inv.apInvoice_payTo_freight_percent                     AS apPaymentDetail_apInvoice_payTo_freight_percent,
            inv.apInvoice_payTo_freight_amount                      AS apPaymentDetail_apInvoice_payTo_freight_amount,
            inv.apInvoice_payTo_charge_inventory_tax_1              AS apPaymentDetail_apInvoice_payTo_charge_inventory_tax_1,
            inv.apInvoice_payTo_charge_inventory_tax_2              AS apPaymentDetail_apInvoice_payTo_charge_inventory_tax_2,
            inv.apInvoice_payTo_charge_inventory_tax_3              AS apPaymentDetail_apInvoice_payTo_charge_inventory_tax_3,
            inv.apInvoice_payTo_charge_inventory_tax_4              AS apPaymentDetail_apInvoice_payTo_charge_inventory_tax_4,
            inv.apInvoice_payTo_federal_id_number_verification      AS apPaymentDetail_apInvoice_payTo_federal_id_number_verification,
            inv.apInvoice_payTo_email_address                       AS apPaymentDetail_apInvoice_payTo_email_address,
            inv.apInvoice_payTo_purchase_order_submit_email         AS apPaymentDetail_apInvoice_payTo_purchase_order_submit_email,
            inv.apInvoice_payTo_allow_drop_ship_to_customer         AS apPaymentDetail_apInvoice_payTo_allow_drop_ship_to_customer,
            inv.apInvoice_payTo_auto_submit_purchase_order          AS apPaymentDetail_apInvoice_payTo_auto_submit_purchase_order,
            inv.apInvoice_payTo_note                                AS apPaymentDetail_apInvoice_payTo_note,
            inv.apInvoice_payTo_phone_number                        AS apPaymentDetail_apInvoice_payTo_phone_number,
            inv.apInvoice_payTo_active                              AS apPaymentDetail_apInvoice_payTo_active,
            inv.apInvoice_payTo_comp_id                             AS apPaymentDetail_apInvoice_payTo_comp_id,
            inv.apInvoice_payTo_comp_time_created                   AS apPaymentDetail_apInvoice_payTo_comp_time_created,
            inv.apInvoice_payTo_comp_time_updated                   AS apPaymentDetail_apInvoice_payTo_comp_time_updated,
            inv.apInvoice_payTo_comp_name                           AS apPaymentDetail_apInvoice_payTo_comp_name,
            inv.apInvoice_payTo_comp_doing_business_as              AS apPaymentDetail_apInvoice_payTo_comp_doing_business_as,
            inv.apInvoice_payTo_comp_client_code                    AS apPaymentDetail_apInvoice_payTo_comp_client_code,
            inv.apInvoice_payTo_comp_client_id                      AS apPaymentDetail_apInvoice_payTo_comp_client_id,
            inv.apInvoice_payTo_comp_dataset_code                   AS apPaymentDetail_apInvoice_payTo_comp_dataset_code,
            inv.apInvoice_payTo_comp_federal_id_number              AS apPaymentDetail_apInvoice_payTo_comp_federal_id_number,
            inv.apInvoice_payTo_comp_include_demo_inventory         AS apPaymentDetail_apInvoice_payTo_comp_include_demo_inventory,
            inv.apInvoice_payTo_comp_address_id                     AS apPaymentDetail_apInvoice_payTo_comp_address_id,
            inv.apInvoice_payTo_comp_address_name                   AS apPaymentDetail_apInvoice_payTo_comp_address_name,
            inv.apInvoice_payTo_comp_address_address1               AS apPaymentDetail_apInvoice_payTo_comp_address_address1,
            inv.apInvoice_payTo_comp_address_address2               AS apPaymentDetail_apInvoice_payTo_comp_address_address2,
            inv.apInvoice_payTo_comp_address_city                   AS apPaymentDetail_apInvoice_payTo_comp_address_city,
            inv.apInvoice_payTo_comp_address_state                  AS apPaymentDetail_apInvoice_payTo_comp_address_state,
            inv.apInvoice_payTo_comp_address_postal_code            AS apPaymentDetail_apInvoice_payTo_comp_address_postal_code,
            inv.apInvoice_payTo_comp_address_latitude               AS apPaymentDetail_apInvoice_payTo_comp_address_latitude,
            inv.apInvoice_payTo_comp_address_longitude              AS apPaymentDetail_apInvoice_payTo_comp_address_longitude,
            inv.apInvoice_payTo_comp_address_country                AS apPaymentDetail_apInvoice_payTo_comp_address_country,
            inv.apInvoice_payTo_comp_address_county                 AS apPaymentDetail_apInvoice_payTo_comp_address_county,
            inv.apInvoice_payTo_comp_address_phone                  AS apPaymentDetail_apInvoice_payTo_comp_address_phone,
            inv.apInvoice_payTo_comp_address_fax                    AS apPaymentDetail_apInvoice_payTo_comp_address_fax,
            inv.apInvoice_payTo_onboard_id                          AS apPaymentDetail_apInvoice_payTo_onboard_id,
            inv.apInvoice_payTo_onboard_value                       AS apPaymentDetail_apInvoice_payTo_onboard_value,
            inv.apInvoice_payTo_onboard_description                 AS apPaymentDetail_apInvoice_payTo_onboard_description,
            inv.apInvoice_payTo_onboard_localization_code           AS apPaymentDetail_apInvoice_payTo_onboard_localization_code,
            inv.apInvoice_payTo_method_id                           AS apPaymentDetail_apInvoice_payTo_method_id,
            inv.apInvoice_payTo_method_value                        AS apPaymentDetail_apInvoice_payTo_method_value,
            inv.apInvoice_payTo_method_description                  AS apPaymentDetail_apInvoice_payTo_method_description,
            inv.apInvoice_payTo_method_localization_code            AS apPaymentDetail_apInvoice_payTo_method_localization_code,
            inv.apInvoice_payTo_address_id                          AS apPaymentDetail_apInvoice_payTo_address_id,
            inv.apInvoice_payTo_address_number                      AS apPaymentDetail_apInvoice_payTo_address_number,
            inv.apInvoice_payTo_address_name                        AS apPaymentDetail_apInvoice_payTo_address_name,
            inv.apInvoice_payTo_address_address1                    AS apPaymentDetail_apInvoice_payTo_address_address1,
            inv.apInvoice_payTo_address_address2                    AS apPaymentDetail_apInvoice_payTo_address_address2,
            inv.apInvoice_payTo_address_city                        AS apPaymentDetail_apInvoice_payTo_address_city,
            inv.apInvoice_payTo_address_state                       AS apPaymentDetail_apInvoice_payTo_address_state,
            inv.apInvoice_payTo_address_postal_code                 AS apPaymentDetail_apInvoice_payTo_address_postal_code,
            inv.apInvoice_payTo_address_latitude                    AS apPaymentDetail_apInvoice_payTo_address_latitude,
            inv.apInvoice_payTo_address_longitude                   AS apPaymentDetail_apInvoice_payTo_address_longitude,
            inv.apInvoice_payTo_address_country                     AS apPaymentDetail_apInvoice_payTo_address_country,
            inv.apInvoice_payTo_address_county                      AS apPaymentDetail_apInvoice_payTo_address_county,
            inv.apInvoice_payTo_address_phone                       AS apPaymentDetail_apInvoice_payTo_address_phone,
            inv.apInvoice_payTo_address_fax                         AS apPaymentDetail_apInvoice_payTo_address_fax,
            inv.apInvoice_payTo_vpt_id                              AS apPaymentDetail_apInvoice_payTo_vpt_id,
            inv.apInvoice_payTo_vpt_time_created                    AS apPaymentDetail_apInvoice_payTo_vpt_time_created,
            inv.apInvoice_payTo_vpt_time_updated                    AS apPaymentDetail_apInvoice_payTo_vpt_time_updated,
            inv.apInvoice_payTo_vpt_company_id                      AS apPaymentDetail_apInvoice_payTo_vpt_company_id,
            inv.apInvoice_payTo_vpt_description                     AS apPaymentDetail_apInvoice_payTo_vpt_description,
            inv.apInvoice_payTo_vpt_number                          AS apPaymentDetail_apInvoice_payTo_vpt_number,
            inv.apInvoice_payTo_vpt_number_of_payments              AS apPaymentDetail_apInvoice_payTo_vpt_number_of_payments,
            inv.apInvoice_payTo_vpt_discount_month                  AS apPaymentDetail_apInvoice_payTo_vpt_discount_month,
            inv.apInvoice_payTo_vpt_discount_days                   AS apPaymentDetail_apInvoice_payTo_vpt_discount_days,
            inv.apInvoice_payTo_vpt_discount_percent                AS apPaymentDetail_apInvoice_payTo_vpt_discount_percent,
            inv.apInvoice_payTo_shipVia_id                          AS apPaymentDetail_apInvoice_payTo_shipVia_id,
            inv.apInvoice_payTo_shipVia_time_created                AS apPaymentDetail_apInvoice_payTo_shipVia_time_created,
            inv.apInvoice_payTo_shipVia_time_updated                AS apPaymentDetail_apInvoice_payTo_shipVia_time_updated,
            inv.apInvoice_payTo_shipVia_description                 AS apPaymentDetail_apInvoice_payTo_shipVia_description,
            inv.apInvoice_payTo_shipVia_number                      AS apPaymentDetail_apInvoice_payTo_shipVia_number,
            inv.apInvoice_payTo_vgrp_id                             AS apPaymentDetail_apInvoice_payTo_vgrp_id,
            inv.apInvoice_payTo_vgrp_time_created                   AS apPaymentDetail_apInvoice_payTo_vgrp_time_created,
            inv.apInvoice_payTo_vgrp_time_updated                   AS apPaymentDetail_apInvoice_payTo_vgrp_time_updated,
            inv.apInvoice_payTo_vgrp_company_id                     AS apPaymentDetail_apInvoice_payTo_vgrp_company_id,
            inv.apInvoice_payTo_vgrp_value                          AS apPaymentDetail_apInvoice_payTo_vgrp_value,
            inv.apInvoice_payTo_vgrp_description                    AS apPaymentDetail_apInvoice_payTo_vgrp_description,
            inv.apInvoice_payTo_has_rebate                          AS apPaymentDetail_apInvoice_payTo_has_rebate,
            ...
            inv.apInvoice_employee_comp_include_demo_inventory       AS apPaymentDetail_apInvoice_employee_comp_include_demo_inventory,
            ...
            vdr.v_active                                             AS apPaymentDetail_vendor_active,
            ...
            vdr.v_comp_include_demo_inventory                        AS apPaymentDetail_vendor_comp_include_demo_inventory,
            ...
            vdr.v_has_rebate                                         AS apPaymentDetail_vendor_has_rebate,
   ...
   @ReadOnly
   fun findOne(id: UUID, company: CompanyEntity): AccountPayablePaymentDetailEntity? {
   ...
   @Transactional
   fun insert(entity: AccountPayablePaymentDetailEntity, company: CompanyEntity): AccountPayablePaymentDetailEntity {
   ...
   @Transactional
   fun update(entity: AccountPayablePaymentDetailEntity, company: CompanyEntity): AccountPayablePaymentDetailEntity {
   ...
   fun mapRowOrNull(rs: ResultSet, company: CompanyEntity, columnPrefix: String = EMPTY): AccountPayablePaymentDetailEntity? =
