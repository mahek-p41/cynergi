   ...
   fun selectBaseQuery(): String {
      return """
         ...
         SELECT
            ...
            account.account_comp_id                                        AS account_comp_id,
            account.account_type_id                                        AS account_type_id,
            account.account_type_value                                     AS account_type_value,
            account.account_type_description                               AS account_type_description,
            account.account_type_localization_code                         AS account_type_localization_code,
            account.account_balance_type_id                                AS account_balance_type_id,
            account.account_balance_type_value                             AS account_balance_type_value,
            account.account_balance_type_description                       AS account_balance_type_description,
            account.account_balance_type_localization_code                 AS account_balance_type_localization_code,
            account.account_status_id                                      AS account_status_id,
            account.account_status_value                                   AS account_status_value,
            account.account_status_description                             AS account_status_description,
            account.account_status_localization_code                       AS account_status_localization_code
