...
class AccountPayableInvoiceSelectedTypeRepository @Inject constructor(
   ...
   fun exists(value: String): Boolean {
      val exists = jdbc.queryForObject("SELECT EXISTS(SELECT id FROM account_payable_invoice_selected_type_domain WHERE UPPER(value) = :value)", mapOf("value" to value.toUpperCase()), Boolean::class.java)!!
