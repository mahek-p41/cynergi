...
class BankReconciliationRepository @Inject constructor(
   ...
   fun selectBaseQuery(): String {
      return """
         ...
         SELECT
            ...
            bank.account_form_1099_field                      AS bank_account_form_1099_field,
            bank.account_corporate_account_indicator          AS bank_account_corporate_account_indicator,
            bank.account_comp_id                              AS bank_account_comp_id,
            bank.account_type_id                              AS bank_account_type_id,
            bank.account_type_value                           AS bank_account_type_value,
            bank.account_type_description                     AS bank_account_type_description,
            bank.account_type_localization_code               AS bank_account_type_localization_code,
            bank.account_balance_type_id                      AS bank_account_balance_type_id,
            bank.account_balance_type_value                   AS bank_account_balance_type_value,
            bank.account_balance_type_description             AS bank_account_balance_type_description,
            bank.account_balance_type_localization_code       AS bank_account_balance_type_localization_code,
            bank.account_status_id                            AS bank_account_status_id,
            bank.account_status_value                         AS bank_account_status_value,
            bank.account_status_description                   AS bank_account_status_description,
            bank.account_status_localization_code             AS bank_account_status_localization_code,
   ...
   private fun mapRow(rs: ResultSet, company: Company, columnPrefix: String = EMPTY): BankReconciliationEntity {
      return BankReconciliationEntity(
         ...
         bank = bankRepository.mapRow(rs, company, "bank_", "bank_"),
