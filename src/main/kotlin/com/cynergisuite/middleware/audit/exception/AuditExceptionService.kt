...
class AuditExceptionService @Inject constructor(
   ...
   fun fetchById(id: Long, company: Company): AuditExceptionEntity? =
      auditExceptionRepository.findOne(id = id, company = company)

   fun fetchAll(auditId: Long, company: Company, pageRequest: PageRequest): RepositoryPage<AuditExceptionEntity, PageRequest> {
