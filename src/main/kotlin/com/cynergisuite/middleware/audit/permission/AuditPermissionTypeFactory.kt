...
object AuditPermissionTypeFactory {
   ...
   private val permissionTypes = listOf(
      ...
      AuditPermissionType(6, "audit-updateSignOff", "Update an audit's status", "audit.update.sign.off"),
      AuditPermissionType(7, "audit-updateSignOffAllExceptions", "Update an audit's status", "audit.update.sign.off.all.exceptions"),
      ...
      AuditPermissionType(15, "auditException-signOff", "Allow user to sign-off on an audit", "audit.exception.sign.off"),
