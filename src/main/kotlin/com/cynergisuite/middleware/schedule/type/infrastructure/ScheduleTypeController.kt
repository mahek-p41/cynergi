...
class ScheduleTypeController @Inject constructor(
   ...
   @Operation(tags = ["ScheduleTypeEndpoints"], summary = "Fetch a listing of Audits", description = "Fetch a paginated listing of Audits", operationId = "scheduleType-fetchAll")
   @ApiResponses(
      value = [
