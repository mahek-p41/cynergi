...
abstract class AuthenticationRepository @Inject constructor(
   ...
   @Query(
      ...
      SELECT
         ...
         compAddr.address1              AS company_address1,
         compAddr.address2              AS company_address2,
         compAddr.city                  AS company_address_city,
         compAddr.state                 AS company_address_state,
         compAddr.postal_code           AS company_address_postalCode,
         ...
         compAddr.address1              AS department_company_address1,
         compAddr.address2              AS department_company_address2,
         compAddr.city                  AS department_company_address_city,
         compAddr.state                 AS department_company_address_state,
         compAddr.postal_code           AS department_company_address_postalCode,
         ...
         compAddr.address1              AS assigned_location_company_address1,
         compAddr.address2              AS assigned_location_company_address2,
         compAddr.city                  AS assigned_location_company_address_city,
         compAddr.state                 AS assigned_location_company_address_state,
         compAddr.postal_code           AS assigned_location_company_address_postalCode,
         ...
         compAddr.address1              AS chosen_location_company_address1,
         compAddr.address2              AS chosen_location_company_address2,
         compAddr.city                  AS chosen_location_company_address_city,
         compAddr.state                 AS chosen_location_company_address_state,
         compAddr.postal_code           AS chosen_location_company_address_postalCode,
   ...
   @Query(
      ...
      SELECT
         ...
         compAddr.address1              AS fallback_location_company_address1,
         compAddr.address2              AS fallback_location_company_address2,
         compAddr.city                  AS fallback_location_company_address_city,
         compAddr.state                 AS fallback_location_company_address_state,
         compAddr.postal_code           AS fallback_location_company_address_postalCode,
