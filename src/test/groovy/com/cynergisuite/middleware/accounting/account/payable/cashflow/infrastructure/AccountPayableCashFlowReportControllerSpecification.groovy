...
class AccountPayableCashFlowReportControllerSpecification extends ControllerSpecificationBase {
   ...
   void "fetch all with multiple vendors and invoices"() {
      ...
      def vendor2 = vendorTestDataLoaderService.single(company, vendor2PmtTerm, vendor2ShipVia, "Beta Biz")
      def vendor3 = vendorTestDataLoaderService.single(company, vendor1PmtTerm, vendor2ShipVia, "Zeta Inc")
